...
go mod edit -replace iano_server/pkg/web=./backend/pkg/web
```
...
```go
import "iano_server/pkg/web/middleware"
...
```bash
ok      iano_server/pkg/web            0.427s
ok      iano_server/pkg/web/middleware  1.182s
