            ...
            <ScrollArea class="flex-1 px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div class="max-w-2xl mx-auto space-y-6 pb-20">
                    ...
                    >
                        ...
                        >
                            <Sparkles
                                class="w-7 h-7 sm:w-8 sm:h-8 text-foreground"
                            />
                        </div>

                        <h2
                            class="text-xl sm:text-2xl font-semibold mb-2 text-foreground"
                        >
                            有什么可以帮您的？
                        </h2>
                        <p
                            class="text-muted-foreground mb-8 sm:mb-10 text-sm sm:text-base"
                        >
                            开始一个新对话，或从左侧选择一个会话
                        </p>
